...
public class VerificationCodeController {
    ...
    public void initialize() throws SQLException {
        ...
        UnaryOperator<TextFormatter.Change> filterfield = change -> {
            ...
            if (newText.matches("[a-zA-Z0-9]") && newText.length() <= 1) {
                return change;
            }
            return null;
        };
    ...
    @FXML
     void UpdatePassword(ActionEvent actionEvent) throws Exception {
        ...
        us.update(new User(CurrentUser.getEmail() , passfield1.getText(), CurrentUser.getName() , CurrentUser.getAge() , CurrentUser.getPhone() , CurrentUser.getRole()));
